...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default='gelan-c-det.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='models/detect/gelan-c.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'Surgical-Dataset/tools.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--min-items', type=int, default=1, help='Experimental')
