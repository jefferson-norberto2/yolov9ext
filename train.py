...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default='gcd.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='models/detect/gelan-c.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/tools.yaml', help='dataset.yaml path')
